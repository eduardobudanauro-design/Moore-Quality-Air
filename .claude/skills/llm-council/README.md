...
This skill is installed in this repository at `.claude/skills/llm-council/`. Claude Code automatically discovers project-level skills, so no extra setup is required when working in this repo.

To install it globally for all your projects:
